              ...
              if RS2_Data_IE_lat(Addr_Width downto 0) /= (0 to Addr_Width => '0') then
                ...
                if data_rvalid_i = '1' then
                  if RS2_Data_IE_lat(Addr_Width downto 0) >= (4 to Addr_Width => '0') & x"4" then
                    ...
                    -- Verilog convertion
                    --case to_integer(unsigned(RS2_Data_IE_lat)) is
                    --  when 1 =>
                    --    ls_sc_data_write_wire(7 downto 0) <= data_rdata_i(7 downto 0);
                    --  when 2 =>
                    --    ls_sc_data_write_wire(15 downto 0) <= data_rdata_i(15 downto 0);
                    --  when 3 =>
                    --    ls_sc_data_write_wire(23 downto 0) <= data_rdata_i(23 downto 0);
                    --  when others =>
                    --    null;
                    --end case;
                  end if;
