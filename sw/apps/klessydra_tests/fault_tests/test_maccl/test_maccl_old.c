...
// code add data
int dt_sz = 4;
unsigned int sub_out[TH_NUM][N_ROW_1][N_COL_2];
unsigned int shf_data[4] = {0x7FFFFFFF, 0x7FFFFFFF, 0x80000000, 0x80000000};
unsigned int shft_out0[TH_NUM][12];
unsigned int shft_out1[TH_NUM][12];
unsigned int relu_data[2] = {0x7FFFFFFF, 0x7FFFFFFF};
unsigned int relu_out[TH_NUM][2];
unsigned int cmp_data0[4] = {0x80808080, 0xFFFFFFFF, 0x7F7F7F7F, 0x00000000};
unsigned int cmp_data1[4] = {0xFFFFFFFF, 0x80808080, 0x00000000, 0x7F7F7F7F};
unsigned int cmp_out0[TH_NUM][4];
unsigned int cmp_out1[TH_NUM][4];

// add after GL simulations
unsigned int shf_out32[TH_NUM][2][N_ROW_1][N_COL_2];
unsigned int shf_out16[TH_NUM][2][N_ROW_1/2][N_COL_2/2];
unsigned int shf_out8 [TH_NUM][2][N_ROW_1/2][N_COL_2/2];
unsigned int m_out8[TH_NUM][N_ROW_1/2][N_COL_2/2];
int d_size;
int idx_i, idx_j;
int v_size;

// add after paper
unsigned int ops_out32[TH_NUM][11][N_ROW_1][N_COL_2];
unsigned int ops_out16[TH_NUM][11][N_ROW_1][N_COL_2];
unsigned int ops_out8 [TH_NUM][11][N_ROW_1][N_COL_2];
  ...
  __asm__("csrrw zero, mcycle, zero");
	...
	for(int i=0; i<NUM_KERNELS; i++){
		...
		//convolution2D_SPM_off_NOB((void*)(	(int*)spmaddrC + i*A_ORDER*A_ORDER), (void*)(	(int*)spmaddrA), (void*)(	(int*)spmaddrB + i*B_ORDER*B_ORDER), (void*)(	(int*)spmaddrD + i*A_ORDER*A_ORDER), A_ORDER);
			...
			//krelu((void*)((int*)spmaddrC + i*A_ORDER*A_ORDER), (void*)((int*)spmaddrC + i*A_ORDER*A_ORDER));
		#endif
	...
	kmemld((void *)((int *)addrB), &m1[0][0], SIZE_OF_INT * u * m);
		...
		for(int i = 0;i < u;i++){
			...
			kmemstr((void *)((int *) &ops_out16[th_id][0][i]), (void *)((int *)addrC), SIZE_OF_INT * m);
			kaddv((void *)((int *)addrC), (void *)((int *)addrA + i*m), (void *)((int *)addrB + i*m));
			kmemstr((void *)((int *) &ops_out16[th_id][1][i]), (void *)((int *)addrC), SIZE_OF_INT * m);
			kvred((void *)((int *)addrC), (void *)((int *)addrA + i*m));
			kmemstr((void *)((int *) &ops_out16[th_id][2][i]), (void *)((int *)addrC), SIZE_OF_INT * m);
			krelu((void *)((int *)addrC), (void *)((int *)addrA + i*m));
			kmemstr((void *)((int *) &ops_out16[th_id][3][i]), (void *)((int *)addrC), SIZE_OF_INT * m);
			kvslt((void *)((int *)addrC), (void *)((int *)addrA + i*m), (void *)((int *)addrB + i*m));
			kmemstr((void *)((int *) &ops_out16[th_id][4][i]), (void *)((int *)addrC), SIZE_OF_INT * m);
			ksvslt((void *)((int *)addrC), (void *)((int *)addrA + i*m), (void *)((int *)addrB + i*m));
			kmemstr((void *)((int *) &ops_out16[th_id][5][i]), (void *)((int *)addrC), SIZE_OF_INT * m);
			kbcast((void *)((int *)addrC), (void *)m2[0][i]);
			kmemstr((void *)((int *) &ops_out16[th_id][6][i]), (void *)((int *)addrC), SIZE_OF_INT * m);
			kvcp((void *)((int *)addrC), (void *)((int *)addrB + i*m));
			kmemstr((void *)((int *) &ops_out16[th_id][7][i]), (void *)((int *)addrC), SIZE_OF_INT * m);

			ksvaddrf((void *)((int *)addrC), (void *)((int *)addrA + i*m), m2[0][i]);
			kmemstr((void *)((int *) &ops_out16[th_id][8][i]), (void *)((int *)addrC), SIZE_OF_INT * m);
			ksvaddsc((void *)((int *)addrC), (void *)((int *)addrB + i*m), (void *) addrA + i);
			kmemstr((void *)((int *) &ops_out16[th_id][10][i]), (void *)((int *)addrC), SIZE_OF_INT * m);
		}
		CSR_MVTYPE(0x00000002);
		//CSR_MVSIZE(u*SIZE_OF_INT);
		for(int i = 0;i < u;i++){
			ksubv((void *)((int *)addrC), (void *)((int *)addrA + i*m), (void *)((int *)addrB + i*m));
			kmemstr((void *)((int *) &ops_out32[th_id][0][i]), (void *)((int *)addrC), SIZE_OF_INT * m);
			kaddv((void *)((int *)addrC), (void *)((int *)addrA + i*m), (void *)((int *)addrB + i*m));
			kmemstr((void *)((int *) &ops_out32[th_id][1][i]), (void *)((int *)addrC), SIZE_OF_INT * m);
			kvred((void *)((int *)addrC), (void *)((int *)addrA + i*m));
			kmemstr((void *)((int *) &ops_out32[th_id][2][i]), (void *)((int *)addrC), SIZE_OF_INT * m);
			krelu((void *)((int *)addrC), (void *)((int *)addrA + i*m));
			kmemstr((void *)((int *) &ops_out32[th_id][3][i]), (void *)((int *)addrC), SIZE_OF_INT * m);
			kvslt((void *)((int *)addrC), (void *)((int *)addrA + i*m), (void *)((int *)addrB + i*m));
			kmemstr((void *)((int *) &ops_out32[th_id][4][i]), (void *)((int *)addrC), SIZE_OF_INT * m);
			ksvslt((void *)((int *)addrC), (void *)((int *)addrA + i*m), (void *)((int *)addrB + i*m));
			kmemstr((void *)((int *) &ops_out32[th_id][5][i]), (void *)((int *)addrC), SIZE_OF_INT * m);
			kbcast((void *)((int *)addrC), (void *)m1[0][i]);
			kmemstr((void *)((int *) &ops_out32[th_id][6][i]), (void *)((int *)addrC), SIZE_OF_INT * m);
			kvcp((void *)((int *)addrC), (void *)((int *)addrA + i*m));
			kmemstr((void *)((int *) &ops_out32[th_id][7][i]), (void *)((int *)addrC), SIZE_OF_INT * m);

			ksvaddrf((void *)((int *)addrC), (void *)((int *)addrA + i*m), m2[0][i]);
			kmemstr((void *)((int *) &ops_out32[th_id][8][i]), (void *)((int *)addrC), SIZE_OF_INT * m);
			ksvaddsc((void *)((int *)addrC), (void *)((int *)addrB + i*m), (void *) addrA + i);
			kmemstr((void *)((int *) &ops_out32[th_id][10][i]), (void *)((int *)addrC), SIZE_OF_INT * m);
		}

		//for(int i = 0;i < u;i++){
		//	for(int j = 0;j < u;j++){
		//		printf("%x ", ops_out32[th_id][0][i][j]);	
		//	}
		//}
		...
		for(int i = 0;i < u;i++){
			ksubv((void *)((int *)addrC), (void *)((int *)addrA + i*m), (void *)((int *)addrB + i*m));
			kmemstr((void *)((int *) &ops_out8[th_id][0][i]), (void *)((int *)addrC), SIZE_OF_INT * m);
			kaddv((void *)((int *)addrC), (void *)((int *)addrA + i*m), (void *)((int *)addrB + i*m));
			kmemstr((void *)((int *) &ops_out8[th_id][1][i]), (void *)((int *)addrC), SIZE_OF_INT * m);
			kvred((void *)((int *)addrC), (void *)((int *)addrA + i*m));
			kmemstr((void *)((int *) &ops_out8[th_id][2][i]), (void *)((int *)addrC), SIZE_OF_INT * m);
			krelu((void *)((int *)addrC), (void *)((int *)addrA + i*m));
			kmemstr((void *)((int *) &ops_out8[th_id][3][i]), (void *)((int *)addrC), SIZE_OF_INT * m);
			kvslt((void *)((int *)addrC), (void *)((int *)addrA + i*m), (void *)((int *)addrB + i*m));
			kmemstr((void *)((int *) &ops_out8[th_id][4][i]), (void *)((int *)addrC), SIZE_OF_INT * m);
			ksvslt((void *)((int *)addrC), (void *)((int *)addrA + i*m), (void *)((int *)addrB + i*m));
			kmemstr((void *)((int *) &ops_out8[th_id][5][i]), (void *)((int *)addrC), SIZE_OF_INT * m);
			kbcast((void *)((int *)addrC), (void *)m1[0][i]);
			kmemstr((void *)((int *) &ops_out8[th_id][6][i]), (void *)((int *)addrC), SIZE_OF_INT * m);
			kvcp((void *)((int *)addrC), (void *)((int *)addrA + i*m));
			kmemstr((void *)((int *) &ops_out8[th_id][7][i]), (void *)((int *)addrC), SIZE_OF_INT * m);

			ksvaddrf((void *)((int *)addrC), (void *)((int *)addrA + i*m), m2[0][i]);
			kmemstr((void *)((int *) &ops_out8[th_id][8][i]), (void *)((int *)addrC), SIZE_OF_INT * m);
			ksvaddsc((void *)((int *)addrC), (void *)((int *)addrB + i*m), (void *) addrA + i);
			kmemstr((void *)((int *) &ops_out8[th_id][10][i]), (void *)((int *)addrC), SIZE_OF_INT * m);
		}
		...
		kmemstr((void *)((int *)shf_out8[th_id][0]), (void *)((int *)addrC), SIZE_OF_INT * u/2 * m);
		for(int i = 0;i < u/2;i++){
			ksrlv((void *)((int *)addrC + i*m), (void *)((int *)addrA + i*m), m2[0][i]);
		}
		kmemstr((void *)((int *)shf_out8[th_id][1]), (void *)((int *)addrC), SIZE_OF_INT * u/2 * m);
		CSR_MVTYPE(0x00000001);
		for(int i = 0;i < u/2;i++){
			ksrav((void *)((int *)addrC + i*m), (void *)((int *)addrA + i*m), m1[1][i]);
		}
		kmemstr((void *)((int *)shf_out16[th_id][0]), (void *)((int *)addrC), SIZE_OF_INT * u/2 * m);
		for(int i = 0;i < u/2;i++){
			ksrlv((void *)((int *)addrC + i*m), (void *)((int *)addrA + i*m), m2[1][i]);
		}
		kmemstr((void *)((int *)shf_out16[th_id][1]), (void *)((int *)addrC), SIZE_OF_INT * u/2 * m);
		CSR_MVTYPE(0x00000002);
		for(int i = 0;i < u/2;i++){
			ksrav((void *)((int *)addrC + i*m), (void *)((int *)addrA + i*m), m1[2][i]);
		}
		kmemstr((void *)((int *)shf_out32[th_id][0]), (void *)((int *)addrC), SIZE_OF_INT * u/2 * m);
		for(int i = 0;i < u/2;i++){
			ksrlv((void *)((int *)addrC + i*m), (void *)((int *)addrA + i*m), m2[2][i]);
		}
		kmemstr((void *)((int *)shf_out32[th_id][1]), (void *)((int *)addrC), SIZE_OF_INT * u/2 * m);
		...
		kmemstr(&m_out8[th_id][0][0],  (void *)((int *)addrC),  d_size);
		// ----------- Shifter ------------
		CSR_MVTYPE(0x00000002);
		...
		kmemstr((void *)((int *)&shft_out0[th_id]), (void *)((int *)addrB), SIZE_OF_INT * dt_sz);
		kmemstr((void *)((int *)&shft_out1[th_id]), (void *)((int *)addrC), SIZE_OF_INT * dt_sz);
		...
		kmemstr((void *)((int *)&shft_out0[th_id] + dt_sz), (void *)((int *)addrB), SIZE_OF_INT * dt_sz);
		kmemstr((void *)((int *)&shft_out1[th_id] + dt_sz), (void *)((int *)addrC), SIZE_OF_INT * dt_sz);
		...
		kmemstr((void *)((int *)&shft_out0[th_id] + 2*dt_sz), (void *)((int *)addrB), SIZE_OF_INT * dt_sz);
		kmemstr((void *)((int *)&shft_out1[th_id] + 2*dt_sz), (void *)((int *)addrC), SIZE_OF_INT * dt_sz);
		...
		// --------- Comparator ---------
		CSR_MVTYPE(0x00000002);
		CSR_MVSIZE(SIZE_OF_INT * 2);

		kmemld((void *)((int *)addrC), (void *)(&relu_data[0]), SIZE_OF_INT * 2);
		krelu((void *)((int *)addrC), (void *)((int *)addrC));
		kmemstr((void *)((int *)&relu_out[th_id]), (void *)((int *)addrC), SIZE_OF_INT * 2);


		CSR_MVTYPE(0x00000000);
		CSR_MVSIZE(SIZE_OF_INT * 4);

		kmemld((void *)((int *)addrA), (void *)(&cmp_data0[0]), SIZE_OF_INT * 4);
		kmemld((void *)((int *)addrB), (void *)(&cmp_data1[0]), SIZE_OF_INT * 4);

		kvslt((void *)((int *)addrC), (void *)((int *)addrA), (void *)((int *)addrB));
		kmemstr((void *)((int *)&cmp_out0[th_id]), (void *)((int *)addrC), SIZE_OF_INT * 4);

		kvslt((void *)((int *)addrC), (void *)((int *)addrB), (void *)((int *)addrA));
		kmemstr((void *)((int *)&cmp_out1[th_id]), (void *)((int *)addrC), SIZE_OF_INT * 4);
